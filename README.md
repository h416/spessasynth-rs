...
This is a partial port of [spessasynth_core v4.3.14](https://github.com/spessasus/spessasynth_core/releases/tag/v4.3.14),
...
The renderer is verified against the upstream TypeScript spessasynth_core v4.3.14. Rendering the
...
- [SpessaSynth](https://github.com/spessasus/SpessaSynth) by spessasus - Original TypeScript implementation (spessasynth_core v4.3.14)
- Rust port by h416
